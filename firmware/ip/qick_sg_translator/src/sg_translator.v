...
// |   xxx | MEM_CLK_DIV | PHRST | STDYSEL | MODE  | OUTSEL |	
...
// IN WAVE PORT
   ...
   // OUT DATA gen_v6_mem (SEL:4)   
   output wire [159:0]  m_gen_v6_mem_axis_tdata  ,
   output wire          m_gen_v6_mem_axis_tvalid ,
   input  wire          m_gen_v6_mem_axis_tready 
);
...
assign gen_v6_mem_en = (OUT_TYPE == 4) ;
...
assign s_axis_tready =  ( gen_v6_en ) ? m_gen_v6_axis_tready : (
                        ...
                        ( gen_v6_mem_en ) ? m_gen_v6_mem_axis_tready : 0 )))); 
///////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////
// axis_signal_gen_v6_memory_interpolator
// |------------|-------|---------|------|------------|------------|------------|-----------|-----------|-------------|----------|----------|---------|
...
// |------------|-------|---------|------|------------|------------|------------|-----------|-----------|-------------|----------|----------|---------|
assign m_gen_v6_mem_axis_tdata[159:149]  = 0                  ;
assign m_gen_v6_mem_axis_tdata[148]      = phrst              ;
assign m_gen_v6_mem_axis_tdata[147]      = stdysel            ;
assign m_gen_v6_mem_axis_tdata[146]      = mode               ;
assign m_gen_v6_mem_axis_tdata[145:144]  = outsel             ;
assign m_gen_v6_mem_axis_tdata[143:112]  = nsamp [31:0]       ;
assign m_gen_v6_mem_axis_tdata[111: 96]  = gain  [15:0]       ;
assign m_gen_v6_mem_axis_tdata[ 95: 86]  = 0                  ;
assign m_gen_v6_mem_axis_tdata[ 85: 80]  = mem_clk_div [5:0]  ;
assign m_gen_v6_mem_axis_tdata[ 79: 64]  = addr  [15:0]       ;
assign m_gen_v6_mem_axis_tdata[ 63: 32]  = phase [31:0]       ;
assign m_gen_v6_mem_axis_tdata[ 31:  0]  = freq  [31:0]       ;

assign m_gen_v6_mem_axis_tvalid = gen_v6_mem_en ? s_axis_tvalid : 0 ;
